...
public class ChangeAfterSale extends AfterSale{
    @Override
...
//    @Autowired
//    public ChangeAfterSale(ExpressDao expressDao, OrderItemDao orderItemDao, CustomerDao customerDao, ShopDao shopDao, ProductDao productDao, ServiceOrderDao serviceOrderDao, RefundDao refundDao){
